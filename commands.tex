...
\newcommand{\dndy}         {\ensuremath{\text{d}N_\text{ch}/\text{d}y}\xspace}
\newcommand{\dndeta}       {\ensuremath{\text{d}N_\text{ch}/\text{d}\eta}\xspace}
...
\newcommand{\vz}           {\ensuremath{{\text V}^{0}}\xspace}