...
\begin{table}[h]
    \centering
    \caption{The final systematic uncertainties for the h-$\Lambda$ $\Delta\varphi$ distributions, the per-trigger jet and UE yields, and the jet widths in all multiplicity and associated momentum bins. The fraction of the systematic uncertainty which is uncorrelated with multiplicity is reported separately in parentheses when available. The low (high) momentum bin is such that $1.5 < p_{T}^{\text{assoc.}} < 2.5$ \GeVc ($2.5 < p_{T}^{\text{assoc.}} < 4.0$ \GeVc).}
    \label{tab:h_lambda_final_systematics}
    \begin{tabular}{| c | c c c c c c |}
        \hline
        Mult. and \pt bin & $\Delta\varphi$ dist. & $Y_{near}$ & $Y_{away}$ & $Y_{UE}$ & $\sigma_{NS}$ & $\sigma_{away}$ \\
        \hline
        0-20\%, low & 3.2\% & 4.8\% & 5.3\% & 3.8\% & 4.6\% & 15.2\% \\
        20-50\%, low & 3.2\% & 4.8\% & 5.3\% & 3.8\% & 4.6\% & 15.2\% \\
        50-80\%, low & 3.2\% & 4.8\% & 5.3\% & 3.8\% & 4.6\% & 15.2\% \\
        \hline
        0-20\%, high & 5.1\% & 4.8\% & 5.3\% & 3.8\% & 4.6\% & 15.2\% \\
        20-50\%, high & 5.1\% & 4.8\% & 5.3\% & 3.8\% & 4.6\% & 15.2\% \\
        50-80\%, high & 5.1\% & 4.8\% & 5.3\% & 3.8\% & 4.6\% & 15.2\% \\
        \hline
    \end{tabular}
\end{table}
