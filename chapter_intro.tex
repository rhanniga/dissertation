...
To account for this, the SHM introduces the concept of \textit{relative} chemical equilibrium, in which the strange phase space is not fully saturated, but whatever strangeness is produced is distributed among the strange hadron channels according to the law of maximum entropy~\cite{9212210_hep-ph}. This 


: as mentioned in the previous section, the full chemical equilibration of strangeness in a hadron gas takes around 



To describe the chemical equilibration of strangeness within the system, the SHM introduces two chemical factors, namely $\lambda_s$ and $\gamma_s$. The factor $\lambda_s$ is called the \textit{strangeness fugacity}, and is defined as
%
\begin{equation}
    \label{eq:strangeness_fugacity}
    \lambda_s = e^{\mu_s/T},
\end{equation}
%
where $\mu_s$ is the strangeness chemical potential. The strangeness fugacity ultimately describes the total abundance of strange quarks and anti-quarks 



The factor $\lambda_s$ is called the \textit{strangeness suppression}, and is defined as
%
\begin{equation}
    \label{eq:strangeness_suppression}
    \lambda_s = \frac{2\langle n_{s\bar{s}} \rangle}{\langle n_{u\bar{u}} \rangle + \langle n_{d\bar{d}} \rangle},
\end{equation}
%
where $\langle n_{j \bar{j}} \rangle$ is the average number of quark-anti-quark pairs of flavor $j$. This factor describes the relative abundance of strange quarks and anti-quarks compared to up and down quarks and anti-quarks, and it approaches unity whenever the strange quarks are in \textit{relative} chemical equilibrium with the $u$ and $d$ quarks. 
...
The statistical hadronization model (SHM) is a theoretical framework that describes the production of hadrons in high-energy nuclear collisions. It assumes that hadrons are formed at the chemical freeze-out, when the system reaches a state of thermal and chemical equilibrium. The SHM predicts that the abundance of hadrons depends only on the available phase space and the conservation laws, and does not depend on the details of the hadronization process.

One of the signatures of the quark-gluon plasma (QGP), a deconfined phase of matter where quarks and gluons can move freely, is the strangeness enhancement. This refers to the increased production of strange particles, such as kaons, lambdas, and omegas, in QGP compared to normal hadronic matter. The strangeness enhancement can be explained by the fact that in QGP, strange quarks and antiquarks are produced abundantly by gluon-gluon collisions, and they hadronize into strange hadrons by recombination or evaporation. The SHM can account for the strangeness enhancement by introducing a fugacity factor $\lambda_s$ for each strange quark or antiquark, which measures the deviation from chemical equilibrium.

The strangeness enhancement can be observed experimentally by comparing the yields of strange particles in different colliding systems, such as proton-proton, proton-nucleus, and nucleus-nucleus collisions. The SHM can fit the experimental data by adjusting the parameters such as temperature, baryon chemical potential, and strangeness fugacity. The SHM has been successful in describing the strangeness enhancement at various energies, from SPS to LHC, and in different collision systems.
